      ...
      <section className="border-t border-gray-100 pt-8 space-y-5">
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            {[['Income Tax Calculator', '/calculator/income-tax'], ['SIP Calculator', '/calculator/sip'], ['Home Loan Calculator', '/calculator/home-loan'], ['NPS Calculator', '/calculator/nps']].map(([l, h]) => (
