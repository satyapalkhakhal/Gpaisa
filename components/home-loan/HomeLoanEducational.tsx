...
const faqs = [
  ...
  { q: 'What is the current HDFC home loan interest rate?', a: 'HDFC Bank home loan interest rates start from around 8.50% to 9.40% p.a. for salaried individuals (as of 2026). The rate depends on your credit score, loan amount, employment type, and property location. Women borrowers may get a 0.05% concession.' },
  { q: 'Can I prepay my HDFC home loan?', a: 'Yes, HDFC Bank allows prepayment of home loans. For floating rate loans, there are no prepayment or foreclosure charges. For fixed rate loans, a prepayment penalty of up to 2% may apply. Prepaying even small amounts early in the loan tenure can significantly reduce your total interest.' },
  ...
  { q: 'Is HDFC home loan interest fixed or floating?', a: 'HDFC Bank offers both fixed and floating rate home loans. Floating rate loans are linked to an external benchmark (RBI repo rate) and can change periodically. Fixed rate loans have a constant rate for the first 2-3 years, then convert to floating. Most borrowers prefer floating rates as they are generally lower.' },
  { q: 'What documents are needed for HDFC home loan?', a: 'Key documents include: Identity proof (Aadhaar, PAN), address proof, income proof (salary slips for 3 months, bank statements for 6 months, Form 16), property documents (sale agreement, title deed, approved plan), and passport-size photographs. Self-employed applicants need ITR for 3 years and business proof.' },
  { q: 'What is the maximum home loan amount I can get?', a: 'HDFC Bank typically offers home loans up to 80-90% of the property value (LTV ratio). The actual amount depends on your income, existing EMIs, credit score, age, and property value. As a rule of thumb, banks approve loans where EMI does not exceed 50-60% of your net monthly income.' },
];
