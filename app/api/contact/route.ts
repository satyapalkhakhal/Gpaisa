                    ...
                    <div style="background: #ffffff; border: 1px solid #e5e7eb; border-top: none; padding: 24px; border-radius: 0 0 12px 12px;">
                        <table style="width: 100%; border-collapse: collapse;">
                            ...
                            <tr style="background: #f9fafb;">
                                ...
                                <td style="padding: 8px 12px; color: #1f2937;">${escapeHtml(category)}</td>
                            </tr>
                            ` : ''}
                        </table>
                        <hr style="border: none; border-top: 1px solid #e5e7eb; margin: 16px 0;" />
                        <h3 style="color: #374151; margin: 0 0 8px 0; font-size: 14px;">Message</h3>
                        <div style="background: #f9fafb; border: 1px solid #e5e7eb; border-radius: 8px; padding: 16px; color: #1f2937; line-height: 1.6; white-space: pre-wrap;">${escapeHtml(message)}</div>
