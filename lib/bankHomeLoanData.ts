...
export const bankHomeLoanData: BankHomeLoanData[] = [
  {
    ...
    metaDescription: "Calculate SBI home loan EMI instantly. SBI rates from 7.25%, NRI rates from 7.75%. Includes SBI MaxGain calculator, amortization schedule & prepayment analysis.",
  ...
  },
  {
    ...
    metaDescription: "Calculate ICICI Bank home loan EMI instantly. Rates from 8.75%, NRI rates from 8.95%. Includes Step-Up EMI calculator, amortization schedule & prepayment analysis.",
  ...
  },
  {
    ...
    metaDescription: "Calculate Kotak Mahindra home loan EMI. Rates from 8.70%, NRI from 8.85%. High-value loans up to ₹10 crore, amortization schedule & prepayment analysis.",
